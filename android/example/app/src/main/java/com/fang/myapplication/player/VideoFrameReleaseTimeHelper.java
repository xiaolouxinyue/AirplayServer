...
public final class VideoFrameReleaseTimeHelper {
   ...
   * shared by all {@link com.google.android.exoplayer2.video.VideoFrameReleaseTimeHelper} instances. This is done to avoid a resource
  ...
  private static final class VSyncSampler implements FrameCallback, Handler.Callback {
    ...
    /**
     * Notifies the sampler that a {@link com.google.android.exoplayer2.video.VideoFrameReleaseTimeHelper} is observing
    ...
    /**
     * Notifies the sampler that a {@link com.google.android.exoplayer2.video.VideoFrameReleaseTimeHelper} is no longer observing
